...
let celebLocations = [
  ...
  tip: {
    en: "<strong>Immersion tip:</strong> Before heading to this address, don't hesitate to re-watch episode 119 of Run BTS! in your hotel room to perfectly recognize the building's exterior architecture and the street where the members arrived.<br><br><strong>Where to take a real coffee break?</strong> With Cafe Camptong closed, fall back on other historic addresses in the neighborhood for your snack. Use the app's map mode to find the nearest open BTS location!",
    fr: "<strong>Le conseil immersion :</strong> Avant de vous rendre à cette adresse, n'hésitez pas à re-visionner l'épisode 119 de Run BTS! dans votre chambre d'hôtel pour reconnaître parfaitement l'architecture extérieure du bâtiment et la rue où les membres sont arrivés.<br><br><strong>Où faire une vraie pause café ?</strong> Le Cafe Camptong étant fermé, rabattez-vous sur d'autres adresses historiques du quartier pour votre goûter. Utilisez le mode carte de l'application pour trouver le lieu BTS ouvert le plus proche !",
    es: "<strong>El consejo de inmersión:</strong> Antes de ir a esta dirección, ¡no dudes en volver a ver el episodio 119 de Run BTS! en tu habitación de hotel...<br><br><strong>¿Dónde tomar un verdadero descanso para el café?</strong> Como el Cafe Camptong está cerrado, recurre a otras direcciones históricas del barrio para tu merienda. ¡Utiliza el modo mapa de la aplicación para encontrar el lugar de BTS abierto más cercano!",
    it: "<strong>Il consiglio per l'immersione:</strong> Prima di recarti a questo indirizzo, non esitare a riguardare l'episodio 119 di Run BTS! nella tua camera d'albergo...<br><br><strong>Dove fare una vera pausa caffè?</strong> Essendo il Cafe Camptong chiuso, ripiega su altri indirizzi storici del quartiere per la tua merenda. Utilizza la modalità mappa dell'app per trovare il luogo BTS aperto più vicino!",
    ko: "<strong>몰입 팁:</strong> 이곳을 방문하기 전, 호텔 방에서 달려라 방탄! 119화를 다시 시청해 보세요...<br><br><strong>진짜 커피 브레이크는 어디서?</strong> 카페 캠프통이 폐업했으니, 간식을 즐기려면 근처의 다른 역사적인 장소들을 방문해 보세요. 앱의 지도 모드를 사용해 가장 가까운 영업 중인 BTS 관련 장소를 찾아보세요!",
    ja: "<strong>没入感のためのヒント：</strong> この場所に向かう前に、ホテルの部屋でRun BTS!のエピソード119をもう一度見直すことをお勧めします...<br><br><strong>本当のコーヒーブレイクはどこで？</strong> Cafe Camptongは閉店しているので、おやつには近隣の他の歴史的な場所を利用しましょう。アプリのマップモードを使って、一番近くの営業しているBTS関連の場所を見つけてください！",
    pt: "<strong>O conselho de imersão:</strong> Antes de ir a este endereço, não hesite em rever o episódio 119 de Run BTS! no seu quarto de hotel...<br><br><strong>Onde fazer uma verdadeira pausa para o café?</strong> Como o Cafe Camptong está fechado, recorra a outros endereços históricos do bairro para o seu lanche. Use o modo mapa do aplicativo para encontrar o local BTS aberto mais próximo!",
    zh: "<strong>沉浸式提示：</strong> 在前往这个地址之前，不要犹豫在酒店房间里重温一遍Run BTS!的第119集...<br><br><strong>去哪里享受真正的咖啡休息时间？</strong> 既然Cafe Camptong关门了，去街区里其他有历史意义的地点吃点点心吧。使用应用程序的地图模式寻找最近的正在营业的防弹少年团相关地点！"
  },
  directions: {

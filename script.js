...
// ==========================================
// 2. DONNÉES : LES 19 LIEUX ET LEURS 3 ONGLET (INFO, STORY, PHOTOS)
// ==========================================
const iconsSVG = {
...
let celebLocations = [
    {
        ...
        videoEmbeds: ["https://www.youtube.com/embed/yiqe-aegVk0", "https://www.youtube.com/embed/wlHS-fpJrm0"], gallery: ["images/Camptong1.jpg", "images/Camptong2.jpg", "https://img.youtube.com/vi/yiqe-aegVk0/hqdefault.jpg"],
        fullDescription: { 
    ...
    {
        id: 2, name: "Ossu Seiromushi", group: "BTS", member: "Jin", country: "South Korea", city: "Seoul", category: "Restaurants", year: "2018", episode: "", episodeLink: "", ytId: "Otsu1",
        ...
        address: "30 Baekjegobun-ro 45-gil, Songpa-gu", lat: 37.5105, lng: 127.1085, img: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600"],
        fullDescription: { 
            en: `<p>Nestled near Seokchon Lake, Ossu Seiromushi represents Jin's successful venture into culinary business alongside his brother.</p><h4>Traditional Steamed Delights</h4><p>Specializing in seiromushi—traditional Japanese wood-steamed dishes—the restaurant pairs high-end cuts of meat and fresh vegetables with an intimate interior design.</p><h4>The ARMY Meeting Point</h4><p>While not a direct filming set, it functions as a pilgrimage site where fans gather to experience a piece of Jin's personal entrepreneurial life.</p>`, 
            fr: `<p>Niché près du lac Seokchon, Ossu Seiromushi illustre le succès de Jin dans la restauration aux côtés de son frère.</p><h4>Cuisine vapeur traditionnelle</h4><p>Spécialisé dans le seiromushi (plats cuits à la vapeur dans du bois), le restaurant propose des viandes et légumes frais dans un cadre intime.</p><h4>Le point de ralliement</h4><p>Bien que ce ne soit pas un lieu de tournage, c'est un lieu incontournable pour les fans souhaitant soutenir l'entreprise de Jin.</p>` 
        },
    ...
    },
    {
        ...
        address: "240 Olympic-ro, Songpa-gu", lat: 37.5113, lng: 127.0980, img: "https://img.youtube.com/vi/d--MDCCJ3jg/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/d--MDCCJ3jg"], gallery: ["https://img.youtube.com/vi/d--MDCCJ3jg/hqdefault.jpg"],
        fullDescription: { 
            en: `<p>Lotte World is the world's largest indoor amusement park, providing an epic playground for Run BTS Episode 51.</p><h4>Privatized Thrills</h4><p>The group rented out the park after hours, screaming their way through the Gyro Drop and the iconic pirate ship.</p>`, 
            fr: `<p>Lotte World est le plus grand parc d'attractions couvert au monde, servant de terrain de jeu épique pour l'épisode 51 de Run BTS.</p><h4>Sensations privatisées</h4><p>Le groupe a privatisé le parc pour affronter les manèges mythiques dans la joie et la terreur.</p>` 
        },
    ...
    },
    {
        ...
        address: "516-7 Songgwangsuman-ro", lat: 35.8455, lng: 127.1895, img: "https://img.youtube.com/vi/h1jUtpEzxxA/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/h1jUtpEzxxA"], gallery: ["https://img.youtube.com/vi/h1jUtpEzxxA/hqdefault.jpg"],
        fullDescription: { 
            en: `<p>A stunning blend of modern concrete art galleries and 250-year-old traditional Korean hanok architecture.</p>`, 
            fr: `<p>Un mélange saisissant de galeries d'art modernes en béton et de maisons traditionnelles coréennes de 250 ans.</p>` 
        },
    ...
    },
    {
        ...
        address: "23 Dosan-daero 13-gil", lat: 37.5197, lng: 127.0229, img: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=600"],
    ...
    },
    {
        ...
        address: "39 Rue du Roi de Sicile, Paris", lat: 48.8569, lng: 2.3572, img: "https://images.unsplash.com/photo-1557142046-c704a3adf365?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1557142046-c704a3adf365?w=600"],
    ...
    },
    {
        ...
        address: "63 Rue de Monceau, Paris", lat: 48.8795, lng: 2.3117, img: "https://img.youtube.com/vi/1TdxCtgX53w/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/1TdxCtgX53w"], gallery: ["https://img.youtube.com/vi/1TdxCtgX53w/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "Rue Foyatier, Paris", lat: 48.8856, lng: 2.3432, img: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600"],
    ...
    },
    {
        ...
        address: "Square Jehan Rictus, Paris", lat: 48.8848, lng: 2.3386, img: "https://images.unsplash.com/photo-1522093005080-d132e14a2e6f?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1522093005080-d132e14a2e6f?w=600"],
    ...
    },
    {
        ...
        address: "13 Av. du Président Wilson, Paris", lat: 48.8643, lng: 2.2965, img: "https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?w=600", videoEmbeds: [], gallery: ["https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?w=600"],
    ...
    },
    {
        ...
        address: "16 Hakdong-ro 30-gil", lat: 37.5144, lng: 127.0315, img: "https://img.youtube.com/vi/vJwHIpEogEY/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/vJwHIpEogEY"], gallery: ["https://img.youtube.com/vi/vJwHIpEogEY/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "29 Nonhyeon-ro 119-gil", lat: 37.5133, lng: 127.0321, img: "https://img.youtube.com/vi/RhJqNFQCU_Q/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/RhJqNFQCU_Q"], gallery: ["https://img.youtube.com/vi/RhJqNFQCU_Q/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "8-55 Hyangho-ri", lat: 37.9048, lng: 128.8266, img: "https://img.youtube.com/vi/46qWWmnK4F0/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/46qWWmnK4F0"], gallery: ["https://img.youtube.com/vi/46qWWmnK4F0/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "327 Samsang-ri", lat: 37.7135, lng: 126.9329, img: "https://img.youtube.com/vi/xEeFrLSkMm8/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/xEeFrLSkMm8"], gallery: ["https://img.youtube.com/vi/xEeFrLSkMm8/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "R. da Francelha de Cima", lat: 38.7844, lng: -9.1238, img: "https://img.youtube.com/vi/GEk4jHwfFTA/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/GEk4jHwfFTA"], gallery: ["https://img.youtube.com/vi/GEk4jHwfFTA/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "Sunhyewon Estate", lat: 37.5826, lng: 126.9856, img: "https://img.youtube.com/vi/Hb06Iem3FWg/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/Hb06Iem3FWg"], gallery: ["https://img.youtube.com/vi/Hb06Iem3FWg/hqdefault.jpg"],
    ...
    },
    {
        ...
        address: "Praça do Império, Lisboa", lat: 38.6976, lng: -9.2082, img: "https://img.youtube.com/vi/b4iVv91Z6lY/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/b4iVv91Z6lY"], gallery: ["https://img.youtube.com/vi/b4iVv91Z6lY/hqdefault.jpg"],
    ...
    },
    {
        ...
        context: { en: "Custom-built mountain estate for healing reality show.", fr: "Domaine de montagne pour émission." },
        address: "Chuncheon, Gangwon-do", lat: 37.8813, lng: 127.7298, img: "https://img.youtube.com/vi/6qB8Nb_WO_Y/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/6qB8Nb_WO_Y"], gallery: ["https://img.youtube.com/vi/6qB8Nb_WO_Y/hqdefault.jpg"],
        fullDescription: { 
            en: `<p>Hidden deep within the pine-covered mountains above Chuncheon, this estate was custom-built for In the SOOP Season 2.</p><h4>Healing in Nature</h4><p>Featuring a private pool, basketball court, and tranquil cabins.</p>`, 
            fr: `<p>Caché au cœur des montagnes de Chuncheon, ce domaine a été construit sur mesure pour In the SOOP Saison 2.</p><h4>Sérénité totale</h4><p>Piscine privée, terrain de basket et cabanes paisibles.</p>` 
        },
        tip: { en: "Book official In the SOOP Stay package.", fr: "Réservez le package officiel." },
        directions: { en: "KTX to Pyeongchang.", fr: "KTX jusqu'à Pyeongchang." }
    },
    {
        ...
        address: "330-48 Chunhwa-ro", lat: 37.9547, lng: 127.6975, img: "https://img.youtube.com/vi/F14vk9qPRM0/hqdefault.jpg", videoEmbeds: ["https://www.youtube.com/embed/F14vk9qPRM0"], gallery: ["https://img.youtube.com/vi/F14vk9qPRM0/hqdefault.jpg"],

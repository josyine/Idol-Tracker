...
let celebLocations = [
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Located in the serene Oseong Hanok Village, Ahwon blends modern concrete galleries with a 250-year-old traditional Korean house. BTS chose this breathtaking location to film their 2019 Summer Package.", 
            fr: "Situé dans le paisible village Hanok d'Oseong, Ahwon mêle galeries modernes et maisons traditionnelles de 250 ans. BTS a choisi ce lieu époustouflant pour filmer le Summer Package 2019." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "A chic French-Japanese aesthetic cafe located in Garosu-gil. Jennie was spotted here enjoying a drink and taking pictures by the famous bamboo entrance.", 
            fr: "Un café à l'esthétique franco-japonaise situé à Garosu-gil. Jennie a été vue ici profitant d'une boisson et prenant des photos à l'entrée avec les bambous." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "During BTS's time in Paris in 2019, Jimin visited Pozzetto, a highly rated artisanal Italian gelato and espresso shop located in the historic Marais district.", 
            fr: "Lors du passage de BTS à Paris en 2019, Jimin a visité Pozzetto, un excellent glacier artisanal italien situé dans le quartier historique du Marais." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Located near Parc Monceau, this spectacular private mansion was chosen by Dior as the backdrop for its 2026 Men's Fashion Week. Jimin's arrival turned the elegant Rue de Monceau into a major pop culture event.", 
            fr: "Situé près du Parc Monceau, cet hôtel particulier spectaculaire a été choisi par Dior pour son défilé Homme 2026. L'arrivée de Jimin a transformé la rue de Monceau en un véritable événement de la pop culture." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "During his free time in Paris, Jimin wandered around the historic Montmartre neighborhood. He shared photos posing gracefully on these steep, picturesque stairs leading up to the Sacré-Cœur.", 
            fr: "Pendant son temps libre à Paris, Jimin s'est promené dans le quartier historique de Montmartre. Il a partagé des photos posant gracieusement sur ces escaliers pittoresques menant au Sacré-Cœur." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Located in the heart of Montmartre, this art installation features the phrase 'I love you' in 250 languages. Jimin visited this spot during his vacation in Paris.", 
            fr: "Située au cœur de Montmartre, cette œuvre d'art affiche la phrase 'Je t'aime' dans 250 langues. Jimin a visité cet endroit romantique pendant ses vacances à Paris." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "This contemporary art museum frequently hosts major Paris Fashion Week events. Jimin drew thousands of fans to its striking brutalist exterior.", 
            fr: "Ce musée d'art contemporain accueille souvent des événements majeurs de la Fashion Week. Jimin y a attiré des milliers de fans devant sa façade brutaliste." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Long before the massive HYBE headquarters existed, this modest building was the cradle of BTS's career. Big Hit Entertainment operated from the second floor, while the basement housed their legendary, cramped practice room. The exterior walls are covered in messages from global fans.", 
            fr: "Bien avant l'immense siège d'HYBE, ce modeste bâtiment fut le berceau de la carrière de BTS. Big Hit Entertainment opérait au deuxième étage, et le sous-sol abritait leur mythique salle de danse. Les murs extérieurs sont couverts de messages de fans du monde entier." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "This unassuming residential building houses the very first apartment shared by BTS during their rookie days. All seven members famously shared a single bedroom with bunk beds.", 
            fr: "Ce bâtiment résidentiel discret abrite le tout premier appartement partagé par BTS à leurs débuts. Les sept membres ont partagé une seule chambre remplie de lits superposés." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Set directly against the backdrop of the East Sea, this structure captures the melancholic vibe of BTS's track, 'Spring Day'. It was temporarily built for the album photoshoot, but the city built a permanent replica due to fan demand.", 
            fr: "Face à la mer de l'Est, cette structure capture l'ambiance mélancolique du titre 'Spring Day'. Construit temporairement pour le photoshoot de l'album, la ville en a fait une réplique permanente face à la demande des fans." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "This rustic, decommissioned station serves as the breathtaking opening shot for the 'Spring Day' music video, where V kneels down in the quiet, wintery landscape to listen to the rails.", 
            fr: "Cette gare rustique désaffectée sert de plan d'ouverture époustouflant pour le clip 'Spring Day', où V s'agenouille dans le paysage hivernal silencieux pour écouter les rails." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "A magnificent 18th-century historic Portuguese estate. BTS chose this venue to film the cinematic music video for 'NORMAL', contrasting traditional architecture with modern pop.", 
            fr: "Un magnifique domaine portugais du 18e siècle. BTS a choisi ce lieu pour filmer le clip cinématographique de 'NORMAL', créant un contraste entre l'architecture traditionnelle et la pop moderne." 
        },
        tip: { en: "It is incredibly easy to swing by and admire the entrance if you are near Lisbon Airport (only a 4-minute drive!).", fr: "C'est incroyablement facile d'y passer admirer l'entrée si vous êtes près de l'aéroport de Lisbonne (4 minutes de route !)." },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Sunhyewon is a breathtaking traditional Korean architectural estate blending living quarters with the natural landscape. BTS used its wooden corridors and stone verandas for a soulful, organic performance.", 
            fr: "Sunhyewon est un domaine architectural traditionnel coréen époustouflant qui se fond dans le paysage naturel. BTS a utilisé ses couloirs en bois et ses vérandas en pierre pour une performance organique et authentique." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Housed in the Jerónimos Monastery, the Navy Museum displays over 17,000 historical items. Fans can spot the members performing striking choreography surrounded by centuries-old maritime artifacts.", 
            fr: "Situé dans le monastère des Hiéronymites, le musée de la Marine expose plus de 17 000 objets historiques. Les fans peuvent voir les membres réaliser des chorégraphies frappantes entourés d'artefacts maritimes centenaires." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Hidden deep within the lush mountains of Chuncheon, this sprawling private estate was completely customized for the show. It features a modern main house, pool, and a private tennis court.", 
            fr: "Caché au fond des montagnes verdoyantes de Chuncheon, ce vaste domaine privé a été entièrement personnalisé pour l'émission. Il comprend une maison moderne, une piscine et un court de tennis privé." 
        },
    ...
    },
    {
        ...
        fullDescription: { 
            en: "Perched high on the mountainsides, this ranch offers breathtaking views of the pristine Chuncheon Lake. It is famous across Korea for its on-site café, serving a signature Hanwoo (Korean beef) burger.", 
            fr: "Perché sur les flancs de la montagne, ce ranch offre une vue imprenable sur le magnifique lac de Chuncheon. Il est célèbre pour son café qui sert un délicieux burger de Hanwoo (bœuf coréen)." 
        },
...
window.generateItinerary = function() {
    ...
    for(let i = 0; i < days; i++) {
        ...
        dayHtml += `<a href="${mapLink}" target="_blank" class="action-btn" style="display:block; padding:10px; margin-top:15px; font-size:0.9rem;">${t('openRouteMap')}</a></div>`;

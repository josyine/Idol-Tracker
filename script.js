...
let celebLocations = [
  ...
  fullDescription: {
    en: `<p>Once nestled in the trendy alleys of Apgujeong, in the heart of Gangnam, Cafe Camptong was a massive five-story urban oasis dedicated to "glamping" (glamorous camping). The concept was pushed to the extreme: fake grass, cozy indoor tents, camping chairs, and string lights offered a rustic escape without leaving Seoul. Although this iconic establishment has unfortunately closed its doors permanently, its address remains a must-visit pilgrimage site for ARMYs. And for good reason: this is where episodes 118 and 119 of <em>Run BTS!</em> were filmed in late 2020, becoming the stage for one of the most chaotic and memorable scavenger hunts in the show's history. Standing in front of the facade allows you to instantly immerse yourself back into that legendary filming day.</p><p>The café's labyrinthine interior was transformed into a veritable playground where the seven members faced off in a frantic post-it hunt (the famous "Photo Story" arc). The anecdotes from this shoot are legendary: one inevitably thinks of Jin's "squirrel syndrome," compulsively snatching up every post-it he found without even reading them, a Machiavellian plan that ultimately backfired. It was also on these stairs that Jungkook literally exhausted his cameraman by sprinting at top speed to escape the others. Between the fleeting alliances, the hilarious betrayals by the Maknae Line (Jimin and V) to validate their poses in the "Photo Zones," and Suga trying to calmly analyze the situation from inside a tent, the building echoed with their laughter and screams all day long.</p><p><strong>Location Status:</strong> Permanently closed. The original establishment with its tents and indoor rooftop no longer exists. However, the building and the alley (at 27 Apgujeong-ro 42-gil, Gangnam-gu) remain accessible public spaces. It's the perfect opportunity to take a souvenir photo of the complex's exterior and check off this legendary milestone on your pilgrimage map.</p><p><strong>What to do around the cafe?</strong> Since you can no longer eat or drink on site, take advantage of being in this highly strategic neighborhood! Just a few minutes' walk away, you can reach the famous K-Star Road to admire the well-known "GangnamDols," or walk to Hakdong Park and the area around BTS's old dorm, foundational places from their trainee days.</p>`,
    fr: `<p>Autrefois niché dans les ruelles branchées d'Apgujeong, au cœur de Gangnam, le Cafe Camptong était une immense oasis urbaine de cinq étages dédiée au "glamping" (le camping glamour). Le concept était poussé à l'extrême : fausse pelouse, tentes d'intérieur douillettes, chaises de camping et guirlandes lumineuses offraient une évasion rustique sans quitter Séoul. Bien que cet établissement emblématique ait malheureusement fermé ses portes définitivement, son adresse reste un lieu de pèlerinage incontournable pour les ARMYs. Et pour cause : c'est ici qu'ont été tournés les épisodes 118 et 119 de <em>Run BTS!</em> fin 2020, devenant le théâtre de l'une des chasses au trésor les plus chaotiques et mémorables de l'histoire de l'émission. Se tenir devant la façade permet de se replonger instantanément dans cette journée de tournage mythique.</p><p>L'intérieur labyrinthique du café s'était alors transformé en un véritable terrain de jeu où les sept membres se sont affrontés lors d'une chasse aux post-it frénétique (le fameux arc "Photo Story"). Les anecdotes de ce tournage sont légendaires : on repense inévitablement au "syndrome de l'écureuil" de Jin, qui arrachait compulsivement tous les post-it trouvés sans même les lire, un plan machiavélique qui s'est finalement retourné contre lui. C'est aussi dans ces escaliers que Jungkook a littéralement épuisé son caméraman à force de sprinter à toute vitesse pour échapper aux autres. Entre les alliances éphémères, les trahisons hilarantes de la Maknae Line (Jimin et V) pour valider leurs poses dans les "Photo Zones", et Suga qui tentait d'analyser calmement la situation depuis une tente, le bâtiment a résonné de leurs rires et de leurs cris toute la journée.</p><p><strong>Statut du lieu :</strong> Fermé définitivement. L'établissement d'origine avec ses tentes et son rooftop intérieur n'existe plus. Cependant, le bâtiment et la ruelle (au 27 Apgujeong-ro 42-gil, Gangnam-gu) restent des espaces publics accessibles. C'est l'occasion parfaite pour prendre une photo souvenir de l'extérieur du complexe et marquer ce point de passage mythique sur votre carte de pèlerinage.</p><p><strong>Que faire autour du café ?</strong> Puisque vous ne pouvez plus consommer sur place, profitez d'être dans ce quartier hautement stratégique ! À quelques minutes de marche de là, vous pouvez rejoindre la célèbre K-Star Road pour admirer les fameux "GangnamDols", ou marcher jusqu'au parc Hakdong et aux environs de l'ancien dortoir de BTS, des lieux fondateurs de leur époque de trainees.</p>`,
    es: `<p>Una vez ubicado en los callejones de moda de Apgujeong, en el corazón de Gangnam, Cafe Camptong era un enorme oasis urbano de cinco pisos dedicado al "glamping" (camping glamoroso)... Aunque este emblemático establecimiento lamentablemente ha cerrado sus puertas de forma permanente, su dirección sigue siendo un lugar de peregrinación de visita obligada para l@s ARMYs. Y por una buena razón: aquí es donde se filmaron los episodios 118 y 119 de <em>Run BTS!</em> a finales de 2020...</p><p>El laberíntico interior del café se transformó en un verdadero patio de recreo... Entre alianzas fugaces, traiciones hilarantes de la Maknae Line (Jimin y V) para validar sus poses en las "Photo Zones", y Suga intentando analizar con calma la situación desde una tienda de campaña, el edificio resonó con sus risas y gritos durante todo el día.</p><p><strong>Estado del lugar:</strong> Cerrado permanentemente. El establecimiento original con sus tiendas y su azotea interior ya no existe. Sin embargo, el edificio y el callejón (en 27 Apgujeong-ro 42-gil, Gangnam-gu) siguen siendo espacios públicos accesibles...</p><p><strong>¿Qué hacer alrededor del café?</strong> Ya que no puedes consumir en el lugar, ¡aprovecha estar en este barrio altamente estratégico! A pocos minutos a pie, puedes llegar a la famosa K-Star Road para admirar los famosos "GangnamDols", o caminar hasta el parque Hakdong y los alrededores del antiguo dormitorio de BTS...</p>`,
    it: `<p>Un tempo incastonato nei vicoli alla moda di Apgujeong, nel cuore di Gangnam, il Cafe Camptong era un'enorme oasi urbana di cinque piani dedicata al "glamping" (campeggio glamour)... Anche se questo iconico stabilimento ha purtroppo chiuso definitivamente i battenti, il suo indirizzo rimane un luogo di pellegrinaggio imperdibile per le/gli ARMY. E per una buona ragione: è qui che sono stati girati gli episodi 118 e 119 di <em>Run BTS!</em> alla fine del 2020...</p><p>L'interno labirintico del caffè si trasformò in un vero e proprio parco giochi... Tra alleanze fugaci, esilaranti tradimenti della Maknae Line (Jimin e V) per convalidare le loro pose nelle "Photo Zones", e Suga che cercava di analizzare con calma la situazione da una tenda, l'edificio ha risuonato delle loro risate e urla per tutto il giorno.</p><p><strong>Stato del luogo:</strong> Chiuso definitivamente. La struttura originale con le sue tende e il rooftop interno non esiste più. Tuttavia, l'edificio e il vicolo (al 27 Apgujeong-ro 42-gil, Gangnam-gu) rimangono spazi pubblici accessibili...</p><p><strong>Cosa fare nei dintorni del caffè?</strong> Poiché non puoi più consumare sul posto, approfitta di essere in questo quartiere altamente strategico! A pochi minuti di cammino, puoi raggiungere la famosa K-Star Road per ammirare i noti "GangnamDols", oppure camminare fino al parco Hakdong e ai dintorni del vecchio dormitorio dei BTS...</p>`,
    ko: `<p>강남의 심장부, 트렌디한 압구정 골목에 자리 잡고 있던 카페 캠프통은 '글램핑'을 테마로 한 5층 규모의 거대한 도심 속 오아시스였습니다... 아쉽게도 이 상징적인 장소는 영구 폐업했지만, 이 주소는 아미들에게 여전히 필수 순례지로 남아있습니다. 그도 그럴 것이 이곳은 2020년 말 <em>달려라 방탄!</em> 118, 119화가 촬영된 곳으로...</p><p>카페의 미로 같은 내부는 일곱 멤버가 열띤 포스트잇 찾기(유명한 '포토 스토리' 에피소드)를 벌이는 진정한 놀이터로 변했습니다... 찰나의 동맹, '포토 존'에서 포즈를 인정받기 위한 막내 라인(지민, 뷔)의 유쾌한 배신, 텐트 안에서 상황을 침착하게 분석하려던 슈가 등 건물은 하루 종일 멤버들의 웃음과 비명으로 가득 찼습니다.</p><p><strong>장소 상태:</strong> 영구 폐업. 텐트와 실내 루프탑이 있던 원래 시설은 더 이상 존재하지 않습니다. 하지만 건물과 골목(강남구 압구정로42길 27)은 여전히 접근 가능한 공공장소입니다...</p><p><strong>카페 주변에서 할 일:</strong> 더 이상 이곳에서 커피를 마실 수는 없지만, 이 전략적인 동네에 있다는 사실을 활용하세요! 걸어서 몇 분만 가면 유명한 '강남돌'을 볼 수 있는 K-Star Road가 있고, 연습생 시절의 발자취가 남은 학동공원과 BTS의 옛 숙소 주변까지 걸어갈 수 있습니다.</p>`,
    ja: `<p>江南の中心部、トレンディな狎鴎亭の路地裏にひっそりと佇んでいたCafe Camptongは、「グランピング」をテーマにした5階建ての巨大な都会のオアシスでした... 残念ながらこの象徴的な店は永久に閉店してしまいましたが、その住所は今でもARMYにとって必見の巡礼地です。それもそのはず、ここは2020年末に<em>Run BTS!</em>のエピソード118と119が撮影された場所であり...</p><p>カフェの迷路のような内部は、7人のメンバーが熱狂的なポストイット探し（有名な「フォトストーリー」編）で対決する本物の遊び場と化しました... 束の間の同盟、「フォトゾーン」でポーズを認めてもらうためのマンネライン（ジミンとV）の爆笑の裏切り、テントの中で状況を冷静に分析しようとしていたシュガなど、建物は一日中彼らの笑い声と叫び声で響き渡っていました。</p><p><strong>場所の状況：</strong> 永久閉店。テントや屋内屋上があった元の施設はもう存在しません。しかし、建物と路地（江南区狎鴎亭路42街27）は依然としてアクセス可能な公共スペースです...</p><p><strong>カフェの周辺で何をする？</strong> ここで飲食することはもうできませんが、この戦略的なエリアにいることを最大限に活用しましょう！歩いて数分のところに、有名な「江南ドル（GangnamDol）」を楽しめるK-Star Roadがあります。また、練習生時代の原点である鶴洞公園やBTSの旧宿舎周辺まで歩いて行くこともできます。</p>`,
    pt: `<p>Outrora aninhado nas vielas da moda de Apgujeong, no coração de Gangnam, o Cafe Camptong era um enorme oásis urbano de cinco andares dedicado ao "glamping" (acampamento glamoroso)... Embora este estabelecimento icônico infelizmente tenha fechado suas portas permanentemente, seu endereço continua sendo um local de peregrinação obrigatório para os ARMYs. E por um bom motivo: foi aqui que os episódios 118 e 119 de <em>Run BTS!</em> foram filmados no final de 2020...</p><p>O interior labiríntico do café se transformou em um verdadeiro playground onde os sete membros se enfrentaram em uma caçada frenética por post-its (o famoso arco "Photo Story")... Entre alianças fugazes, as hilárias traições da Maknae Line (Jimin e V) para validar suas poses nas "Photo Zones", e Suga tentando analisar calmamente a situação de dentro de uma tenda, o prédio ecoou com seus risos e gritos o dia todo.</p><p><strong>Status do local:</strong> Permanentemente fechado. O estabelecimento original com suas tendas e terraço interno não existe mais. No entanto, o prédio e o beco (em 27 Apgujeong-ro 42-gil, Gangnam-gu) continuam sendo espaços públicos acessíveis...</p><p><strong>O que fazer ao redor do café?</strong> Já que você não pode mais consumir no local, aproveite estar neste bairro altamente estratégico! A poucos minutos de caminhada, você pode chegar à famosa K-Star Road para admirar os conhecidos "GangnamDols", ou caminhar até o Parque Hakdong e os arredores do antigo dormitório do BTS...</p>`,
    zh: `<p>Cafe Camptong曾经坐落在江南中心时尚的狎鸥亭小巷中，是一个占地五层、以“豪华露营”为主题的巨大都市绿洲... 尽管这家标志性的店面遗憾地已永久关闭，但它的地址依然是ARMY们必去的朝圣地。原因很简单：这里是2020年底<em>Run BTS!</em>第118和119集的拍摄地...</p><p>咖啡馆迷宫般的内部变成了一个真正的游乐场，七名成员在这里展开了疯狂的便利贴寻找战（著名的“照片故事”篇）... 在短暂的结盟、忙内小分队（Jimin和V）为了在“拍照区”认证姿势而上演的搞笑背叛，以及Suga试图在帐篷里冷静分析局势之间，整栋建筑一整天都回荡着他们的笑声和尖叫声。</p><p><strong>地点状态：</strong> 永久关闭。最初带有帐篷和室内屋顶的设施已不复存在。然而，建筑和所在的小巷（江南区狎鸥亭路42街27号）仍然是可进入的公共空间...</p><p><strong>在咖啡馆周围做什么？</strong> 既然你已经不能在这里消费了，那就充分利用在这个极具战略意义的街区的时间吧！步行几分钟，你就可以到达著名的韩流明星大道（K-Star Road）欣赏著名的“江南熊（GangnamDols）”，或者步行去鹤洞公园和防弹少年团旧宿舍附近...</p>`
  },
  tip: {
    en: `<strong>Immersion tip:</strong> Before heading to this address, don't hesitate to re-watch episode 119 of Run BTS! in your hotel room to perfectly recognize the building's exterior architecture and the street where the members arrived.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>Where to take a real coffee break?</strong> With Cafe Camptong closed, fall back on other historic addresses in the neighborhood for your snack. Use the app's map mode to find the nearest open BTS location!</div></div>`,
    fr: `<strong>Le conseil immersion :</strong> Avant de vous rendre à cette adresse, n'hésitez pas à re-visionner l'épisode 119 de Run BTS! dans votre chambre d'hôtel pour reconnaître parfaitement l'architecture extérieure du bâtiment et la rue où les membres sont arrivés.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>Où faire une vraie pause café ?</strong> Le Cafe Camptong étant fermé, rabattez-vous sur d'autres adresses historiques du quartier pour votre goûter. Utilisez le mode carte de l'application pour trouver le lieu BTS ouvert le plus proche !</div></div>`,
    es: `<strong>El consejo de inmersión:</strong> Antes de ir a esta dirección, ¡no dudes en volver a ver el episodio 119 de Run BTS! en tu habitación de hotel para reconocer perfectamente la arquitectura exterior del edificio y la calle por donde llegaron los miembros.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>¿Dónde tomar un verdadero descanso para el café?</strong> Como el Cafe Camptong está cerrado, recurre a otras direcciones históricas del barrio para tu merienda. ¡Utiliza el modo mapa de la aplicación para encontrar el lugar de BTS abierto más cercano!</div></div>`,
    it: `<strong>Il consiglio per l'immersione:</strong> Prima di recarti a questo indirizzo, non esitare a riguardare l'episodio 119 di Run BTS! nella tua camera d'albergo per riconoscere perfettamente l'architettura esterna dell'edificio e la strada da cui sono arrivati i membri.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>Dove fare una vera pausa caffè?</strong> Essendo il Cafe Camptong chiuso, ripiega su altri indirizzi storici del quartiere per la tua merenda. Utilizza la modalità mappa dell'app per trovare il luogo BTS aperto più vicino!</div></div>`,
    ko: `<strong>몰입 팁:</strong> 이곳을 방문하기 전, 호텔 방에서 달려라 방탄! 119화를 다시 시청해 보세요. 건물의 외관과 멤버들이 도착했던 거리를 완벽하게 알아볼 수 있을 것입니다.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>진짜 커피 브레이크는 어디서?</strong> 카페 캠프통이 폐업했으니, 간식을 즐기려면 근처의 다른 역사적인 장소들을 방문해 보세요. 앱의 지도 모드를 사용해 가장 가까운 영업 중인 BTS 관련 장소를 찾아보세요!</div></div>`,
    ja: `<strong>没入感のためのヒント：</strong> この場所に向かう前に、ホテルの部屋でRun BTS!のエピソード119をもう一度見直すことをお勧めします。建物の外観やメンバーが到着した通りを完璧に認識できるようになります。<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>本当のコーヒーブレイクはどこで？</strong> Cafe Camptongは閉店しているので、おやつには近隣の他の歴史的な場所を利用しましょう。アプリのマップモードを使って、一番近くの営業しているBTS関連の場所を見つけてください！</div></div>`,
    pt: `<strong>O conselho de imersão:</strong> Antes de ir a este endereço, não hesite em rever o episódio 119 de Run BTS! no seu quarto de hotel para reconhecer perfeitamente a arquitetura exterior do edifício e a rua onde os membros chegaram.<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>Onde fazer uma verdadeira pausa para o café?</strong> Como o Cafe Camptong está fechado, recorra a outros endereços históricos do bairro para o seu lanche. Use o modo mapa do aplicativo para encontrar o local BTS aberto mais próximo!</div></div>`,
    zh: `<strong>沉浸式提示：</strong> 在前往这个地址之前，不要犹豫在酒店房间里重温一遍Run BTS!的第119集，这样你就能完美认出建筑的外观和成员们到达的街道。<br><br><div style="display:flex; gap:12px; align-items:flex-start; margin-left:-36px;"><div style="width:24px; height:24px; background:#D42759; color:#fff; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:13px; flex-shrink:0;">2</div><div><strong>去哪里享受真正的咖啡休息时间？</strong> 既然Cafe Camptong关门了，去街区里其他有历史意义的地点吃点点心吧。使用应用程序的地图模式寻找最近的正在营业的防弹少年团相关地点！</div></div>`
  },
  directions: {
